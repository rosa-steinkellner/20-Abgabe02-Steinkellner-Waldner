 ...
 * of testing, the Queue object is specified to hold elements of the type String.
 *
...
public class GenericQueueStringTest {
    ...
    void testOffer() {
        assertTrue(genericQueue.offer("Mutzi"));
        genericQueue.offer("Sunny");
        genericQueue.offer("Cloudy");
        genericQueue.offer("Stormy");
        assertFalse(genericQueue.offer("Angry"));
    }
